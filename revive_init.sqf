...
_Base_3 						= "";				//array no.15
_Base_4 						= "";				//array no.16 
_Base_free_respawn 				= [0,0,0,0];		//array no.36 - allow spawning at spawn points even if enemy troops are present (options OFF = 0, ON = 1) 
...
_can_revive 					= "B_Soldier_base_F";//array no.18 
...
_unit_medpacks 					= 3;				//array no.84 - No of medpacks as specified in _can_revive variables - required for reviving units			
