// supplies.sqf
// OCTOBER 2013 - norrin
private ["_medic_medpacks","_unit_medpacks","_medic_bandages","_unit_bandages","_medic_1","_medic_2","_med_supplies"];
...
if (!isNil "NORRN_medSuppliesAction") then {player removeAction NORRN_medSuppliesAction};
